...
export default function BorrowingPage() {
  ...
  const fetchMembers = useDebounce(async (query: string) => {
    ...
    const results = await window.electronAPI.members.search(query)
    setMemberOptions(results.map((m: MemberDTO) => ({ id: m.id, name: m.fullName })))
  }, 300)
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 space-y-2">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-800">{selectedMember.number}</span>
                </div>
                <div className="flex justify-between">
