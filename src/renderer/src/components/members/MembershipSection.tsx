        ...
        <div>
          ...
          <div className="flex gap-2">
            <select
              ...
              className={`flex-1 px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.memberType ? 'border-red-400' : 'border-slate-300'}`}
            >
