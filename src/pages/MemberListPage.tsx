...
export default function MemberListPage({ memberType, title, newButtonLabel }: MemberListPageProps) {
  ...
  async function fetchMembers() {
    setLoading(true)
    try {
      const result = await api.members.findMany(query.search || undefined, query.page, limit, memberType)
      setData(result.data)
  ...
  useEffect(() => {
    fetchMembers()
  }, [query.search, query.page, memberType])
