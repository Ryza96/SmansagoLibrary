// WO MEMBER PHOTO — Resize foto anggota via sharp.
// Mengikuti pola book-cover-resize.ts (WO SAM SAMPUL BUKU §9):
...
export const MEMBER_PHOTO_RESIZE_MAX_DIMENSION = 512

export async function resizeMemberPhotoImage(
  sourcePath: string,
  maxDimension: number = MEMBER_PHOTO_RESIZE_MAX_DIMENSION
): Promise<Buffer> {
